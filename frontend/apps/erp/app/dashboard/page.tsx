  ...
  return (
    <main style={{ padding: "32px", fontFamily: "var(--font-body)" }}>
      ...
      <div style={{ marginTop: "24px", display: "flex", flexWrap: "wrap", gap: "12px" }}>
        ...
        >
          <div style={{ color: "var(--navy-primary)", fontWeight: 600, fontSize: "15px" }}>Users</div>
          <div style={{ color: "var(--ink)", opacity: 0.65, fontSize: "13px", marginTop: "4px" }}>
            Manage logins, roles, and profile links (Admin only)
          </div>
        </Link>
        ...
        >
          <div style={{ color: "var(--navy-primary)", fontWeight: 600, fontSize: "15px" }}>Library</div>
          <div style={{ color: "var(--ink)", opacity: 0.65, fontSize: "13px", marginTop: "4px" }}>
            Manage the book catalog and issue/return records
          </div>
        </Link>
        ...
        >
          <div style={{ color: "var(--navy-primary)", fontWeight: 600, fontSize: "15px" }}>Guardians</div>
          <div style={{ color: "var(--ink)", opacity: 0.65, fontSize: "13px", marginTop: "4px" }}>
            Manage parent/guardian profiles and link them to students
          </div>
        </Link>
